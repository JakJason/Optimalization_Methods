...
class BatAlgorithm:
    ...
    def init(self):
        ...
        for i in range(0, self.n_vampires):
            self.vampires.append(Vampire(self.x_min, self.x_max, self.y_min, self.y_max, self.function))
...
class Vampire:
    ...
    def __init__(self, x_min, x_max, y_min, y_max, function):
...
if __name__ == "__main__":
    Bat = BatAlgorithm([-5, 5, -5, 5, 1001, 100])
    Bat.start()
    plt.show()
